...
export class Notations {
  ...
  getOrnaments(): Ornaments[] {
    return this.element
      .all('ornaments')
      .map((element) => new Ornaments(element))
  }
  ...
  getArticulations(): Articulations[] {
    return this.element
      .all('articulations')
      .map((element) => new Articulations(element))
  }

  /** Returns the accidental marks of the notations (not ornaments). */
  getAccidentalMarks(): AccidentalMark[] {
    return this.element
      .children('accidental-mark')
      .map((element) => new AccidentalMark(element))
  }
  ...
  getTechnicals(): Technical[] {
    return this.element
      .children('technical')
      .map((element) => new Technical(element))
  }
