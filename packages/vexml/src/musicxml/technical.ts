...
export class Technical {
  ...
  getDownBows(): DownBow[] {
    return this.element
      .children('down-bow')
      .map((element) => new DownBow(element))
  }
  ...
  getHarmonics(): Harmonic[] {
    return this.element
      .children('harmonic')
      .map((element) => new Harmonic(element))
  }

  /** Returns the open strings of the technical. */
  getOpenStrings(): OpenString[] {
    return this.element
      .children('open-string')
      .map((element) => new OpenString(element))
  }

  /** Returns the thumb positions of the technical. */
  getThumbPositions(): ThumbPosition[] {
    return this.element
      .children('thumb-position')
      .map((element) => new ThumbPosition(element))
  }
  ...
  getFingerings(): Fingering[] {
    return this.element
      .children('fingering')
      .map((element) => new Fingering(element))
  }
  ...
  getDoubleTongues(): DoubleTongue[] {
    return this.element
      .children('double-tongue')
      .map((element) => new DoubleTongue(element))
  }

  /** Returns the triple tongues of the technical. */
  getTripleTongues(): TripleTongue[] {
    return this.element
      .children('triple-tongue')
      .map((element) => new TripleTongue(element))
  }
  ...
  getStopped(): Stopped[] {
    return this.element
      .children('stopped')
      .map((element) => new Stopped(element))
  }

  /** Returns the snap pizzicatos of the technical. */
  getSnapPizzicatos(): SnapPizzicato[] {
    return this.element
      .children('snap-pizzicato')
      .map((element) => new SnapPizzicato(element))
  }
  ...
  getTabStrings(): TabString[] {
    return this.element
      .children('string')
      .map((element) => new TabString(element))
  }
  ...
  getHammerOns(): HammerOn[] {
    return this.element
      .children('hammer-on')
      .map((element) => new HammerOn(element))
  }
  ...
  getPullOffs(): PullOff[] {
    return this.element
      .children('pull-off')
      .map((element) => new PullOff(element))
  }
  ...
  getFingernails(): Fingernails[] {
    return this.element
      .children('fingernails')
      .map((element) => new Fingernails(element))
  }
}
