...
export class Fragment {
  ...
  render(): FragmentRender {
    ...
    const vexflowStaveConnectors =
      this.renderVexflowStaveConnectors(partRenders)
    ...
    const partLabelGroupRender = this.renderPartLabelGroup(
  ...
  private accountForPartLabelGroupWidth(pen: Pen, widthBudget: Budget): void {
    ...
    const partLabelGroup = new PartLabelGroup(
      this.config,
      this.log,
      this.document,
      this.key,
