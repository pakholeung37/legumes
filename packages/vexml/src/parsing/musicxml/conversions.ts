...
export const fromNoteTypeToDurationType = (
  noteType: musicxml.NoteType | null,
): data.DurationType | null => {
  switch (noteType) {
    case '1024th':
      return '1024'
    case '512th':
...
export const fromFractionToDurationType = (
  fraction: Fraction,
): [durationType: data.DurationType, dotCount: number] => {
...
export const fromStemToStemDirection = (
...
export const fromNoteheadToNotehead = (
  notehead: musicxml.Notehead | null,
): Notehead => {
  switch (notehead) {
    case 'circle dot':
    case 'cluster':
...
export const fromAlterToAccidentalCode = (
  alter: number | null,
): data.AccidentalCode => {
  switch (alter) {
    case 1:
...
export const fromClefPropertiesToClefSign = (
