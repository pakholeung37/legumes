...
export const ACCIDENTAL_CODES = new Enum([
  '#',
  '##',
  'b',
  'bb',
 ...
 */
export type AnnotationHorizontalJustification = EnumValues<
  typeof ANNOTATION_HORIZONTAL_JUSTIFICATIONS
>
export const ANNOTATION_HORIZONTAL_JUSTIFICATIONS = new Enum([
  'left',
  'center',
  'right',
  'centerstem',
 ...
 */
export type AnnotationVerticalJustification = EnumValues<
  typeof ANNOTATION_VERTICAL_JUSTIFICATIONS
>
export const ANNOTATION_VERTICAL_JUSTIFICATIONS = new Enum([
  'top',
  'center',
  'bottom',
  'centerstem',
...
export const ENDING_BRACKET_TYPES = new Enum([
  'begin',
  'mid',
  'end',
  'both',
...
export const CURVE_ARTICULATIONS = new Enum([
  'unspecified',
  'slide',
  'hammeron',
  'pulloff',
