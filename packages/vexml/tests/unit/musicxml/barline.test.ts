...
describe(Barline, () => {
  describe('getBarStyle', () => {
    it.each(BAR_STYLES.values)(
      `returns the bar style of the barline: '%s'`,
      (barStyle) => {
        const node = xml.barline({
          barStyle: xml.barStyle({ value: barStyle }),
        })
  ...
  describe('getRepeatDirection', () => {
    it.each(['backward', 'forward'])(
      `returns the repeat direction of the barline: '%s'`,
      (direction) => {
  ...
  describe('getLocation', () => {
    it.each(['right', 'left', 'middle'])(
      `returns the location of the barline: '%s'`,
      (location) => {
  ...
  describe('getEndingType', () => {
    it.each(['start', 'stop', 'discontinue'])(
      `returns the ending type of the barline: '%s'`,
      (endingType) => {
