...
describe(LazyCursorStateHintProvider, () => {
  it('does not throw when the previous frame is undefined', () => {
    ...
    const provider = new LazyCursorStateHintProvider(
      currentFrame,
      previousFrame,
      hintDescriber,
    )
  ...
  it('provides for: single measure, multiple staves, different notes', () => {
    ...
    expect(states[5].hints.toHumanReadable()).toEqual([
      'stop(element(8))',
      'start(element(9))',
    ])
  ...
  it('provides for: single measure, multiple staves, multiple parts', () => {
    ...
    expect(states0[2].hints.toHumanReadable()).toEqual([
      'stop(element(1))',
      'start(element(2))',
    ])
    ...
    // stave0: 0 1 2 3
    // stave1: 4 5 6 7
    expect(states1[0].hints.toHumanReadable()).toEqual([
      'start(element(0))',
      'start(element(4))',
    ])
  ...
  it('provides for: documents that have backwards formatting', () => {
    ...
    expect(states[7].hints.toHumanReadable()).toEqual([
      'stop(element(5))',
      'start(element(6))',
    ])
    ...
    expect(states[9].hints.toHumanReadable()).toEqual([
      'stop(element(17))',
      'start(element(18))',
    ])
    expect(states[10].hints.toHumanReadable()).toEqual([
      'stop(element(7))',
      'start(element(8))',
    ])
    expect(states[11].hints.toHumanReadable()).toEqual([
      'stop(element(8))',
      'start(element(9))',
    ])
    ...
    expect(states[13].hints.toHumanReadable()).toEqual([
      'stop(element(10))',
      'start(element(11))',
    ])
    expect(states[14].hints.toHumanReadable()).toEqual([
      'stop(element(11))',
      'start(element(12))',
    ])
  })
  ...
  it('provides for: chords', () => {
    ...
    expect(states0[0].hints.toHumanReadable()).toEqual([
      'start(element(0))',
      'start(element(3))',
    ])
    expect(states0[1].hints.toHumanReadable()).toEqual([
